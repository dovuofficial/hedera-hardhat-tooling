...
contract HTS is HederaTokenService {
    ...
    function tokenAssociate() external {
        int256 response = HederaTokenService.associateToken(address(this), tokenAddress);
    ...
    function tokenDissociate() external {
        ...
        int256 response = HederaTokenService.dissociateToken(address(this), tokenAddress);
